// Package ibmcloud generates Machine objects for ibm cloud.
package ibmcloud
...
func provider(clusterID string, platform *ibmcloud.Platform, mpool *ibmcloud.MachinePool, osImage string, azIdx int, role, userDataSecret string) (*gcpprovider.GCPMachineProviderSpec, error) {
...
func getNetworks(platform *ibmcloud.Platform, clusterID, role string) (string, string, error) {
	if platform.Network == "" {
